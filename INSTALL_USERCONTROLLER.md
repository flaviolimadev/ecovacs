# INSTRUÇÕES PARA ATUALIZAR UserController.php NO SERVIDOR

## Cole este comando completo no SSH:

```bash
cd /app

# Backup
cp app/Http/Controllers/API/V1/Admin/UserController.php app/Http/Controllers/API/V1/Admin/UserController.php.BACKUP

# Criar arquivo novo
cat > app/Http/Controllers/API/V1/Admin/UserController.php << 'EOFILE'
<?php
...
echo 'Estrutura retornada:' . PHP_EOL;
...
2. Cria o arquivo UserController.php completo via `cat`
3. Verifica número de linhas (deve ter 521)
4. Verifica se tem getReferralNetwork (deve ter pelo menos 3 ocorrências)
5. Limpa caches
6. Testa se a estrutura está OK

**Cole TODO o bloco de uma vez no SSH!**
